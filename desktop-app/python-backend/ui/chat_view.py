...
def show_erosion_alert_popup():
    ...
    def erosion_alert_dialog():
        ...
        with col2:
            if st.button("✓ I Understand", type="primary", use_container_width=True, key="erosion_understand_btn_chatview"):
                # Set flag to False to close dialog
...
class ChatView:
    ...
    def render_live_metrics(self, orchestrator, erosion_threshold: float = 0.15):
        """
        ...
        if len(metrics_df) > 0 and 'GuardrailErosion_a(N)' in metrics_df.columns:
